...
<section>
    <div class="container">
        <canvas id="constructors" width="400" height="400"></canvas>
    </div>
</section>
<!-- JavaScript-->
<script>
...
var ctx = document.getElementById('constructors').getContext('2d');
var constructors = new Chart(ctx, {
    type: 'line',
    data: {
        labels: js_labels,
        datasets: [
            @php 
            foreach($constructors_linechart as $data){
                $name = $data['name'];
                $data_points = [];
